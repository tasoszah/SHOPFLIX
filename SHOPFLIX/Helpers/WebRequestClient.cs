...
namespace SHOPFLIX
{
        ...
        where TAuthenticationArgs : class
    {
        ...
        /// <returns></returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public async Task<HttpResponseMessage> PutAsync(string url, object? content, TAuthenticationArgs? authenticationArgs, CancellationToken cancellationToken = default)
        {
            // Set the authorization scheme
            SetAuthorizationHeader(authenticationArgs);
            ...
            {
                // Send it with the request
                return await Client.PutAsync(url, content is null ? null : CreateStringContent(content), cancellationToken);
            }
            catch
            {
                // Re-throw
        ...
        /// <returns></returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public async Task<HttpResponseMessage> PatchAsync(string url, object? content, TAuthenticationArgs authenticationArgs, CancellationToken cancellationToken = default)
        {
            // Set the authorization scheme
            SetAuthorizationHeader(authenticationArgs);
            ...
            try
            {
                ...
                {
                    Content = content is null ? null : CreateStringContent(content)
                };
        ...
        /// <returns></returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public async Task<HttpResponseMessage> DeleteAsync(string url, TAuthenticationArgs? authenticationArgs, CancellationToken cancellationToken = default)
        {
            // Set the authorization scheme
            SetAuthorizationHeader(authenticationArgs);
        ...
        /// <param name="cancellationToken">The cancellation token</param>
        /// <returns></returns>
        public async Task<WebRequestResult<TResponse>> PutAsync<TResponse>(string url, object? content, TAuthenticationArgs? authenticationArgs, CancellationToken cancellationToken = default)
        {
            // Create server response holder
            HttpResponseMessage serverResponse;
            try
            {
                ...
                serverResponse = await PutAsync(url, content, authenticationArgs, cancellationToken);
            }
            catch (Exception ex)
            {
                // If we got unexpected error, return that
        ...
        /// <param name="cancellationToken">The cancellation token</param>
        /// <returns></returns>
        public async Task<WebRequestResult<TResponse>> PatchAsync<TResponse>(string url, object? content, TAuthenticationArgs authenticationArgs, CancellationToken cancellationToken = default)
        {
            // Create server response holder
            HttpResponseMessage serverResponse;
            try
            {
                ...
                serverResponse = await PatchAsync(url, content, authenticationArgs, cancellationToken);
            }
            catch (Exception ex)
            {
                // If we got unexpected error, return that
        ...
        /// <param name="cancellationToken">The cancellation token</param>
        /// <returns></returns>
        public async Task<WebRequestResult<TResponse>> DeleteAsync<TResponse>(string url, TAuthenticationArgs? authenticationArgs, CancellationToken cancellationToken = default)
        {
            // Create server response holder
            HttpResponseMessage serverResponse;
            try
            {
                ...
                serverResponse = await DeleteAsync(url, authenticationArgs, cancellationToken);
            }
            catch (Exception ex)
            {
                // If we got unexpected error, return that
